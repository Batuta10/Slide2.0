...
import PageMobx from './Views/Page/PageMobx';
...
class Base extends Component {
    ...
    renderRoute() {
        ...
        switch (page) {
            case 'Home':
                return <Slide imgs={images} />;
            case 'List':
                return <ListIMG imgs={images} getPhoto={this.getPhoto} />;
            case 'HomeMobx':
                return <PageMobx />;
            default:
                return <NoMatch />;
    ...
    render() {
        return (
            <div>
                ...
                <div id="main">{this.state.images.length ? this.renderRoute() : this.state.loading}</div>
            </div>
        );
    }
}
